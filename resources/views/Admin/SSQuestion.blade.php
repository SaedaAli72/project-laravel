                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row">
                          <div class="custom-file col-md-6 mb-3">
                            <label for="validatedCustomFile">Avatar</label>
                            
                            <input type="file" class="custom-file-input" id="validatedCustomFile" required>
                            <label class="custom-file-label" for="validatedCustomFile"></label>
                          </div>
                          <div class="col-md-6 mb-3">
                            <label for="validationTextarea"> Is Avatar</label>
                            <select class="custom-select" id="validationDefault04" required>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form>
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                    <label for="validationDefault01">Subject-Name</label>
                    <input type="text" class="form-control" id="validationDefault01" value="Mark" required>
                  </div>
                  <div class="col-md-6 mb-3">
                    <label for="validationDefault02">Question</label>
                    <input type="text" class="form-control" id="validationDefault02" value="" required>
                  </div>
                </div>
                <div class="form-row">
                <div class="col-md-6 mb-3">
                  ...
                  <select class="custom-select" id="validationDefault04" required>
                    <option selected disabled value="">MCQ</option>
                    <option>Text</option>
                  </select>
                </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                      <label for="validationTextarea">Answer</label>
                      <textarea class="form-control is-invalid" id="validationTextarea" placeholder="" required></textarea>
                    
                    </div>
                    <div class="col-md-6 mb-3">
                      <label for="validationDefault04">Deffculity</label>
                      <select class="custom-select" id="validationDefault04" required>
                        <option selected disabled value="">Easy</option>
